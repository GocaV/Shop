...
namespace Shop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        [TestMethod]
        public void CanGetSymmaryViewModel() {
            IRepository<Basket> baskets = new MockContext<Basket>();
            IRepository<Product> products = new MockContext<Product>();
            IRepository<Order> orders = new MockContext<Order>();
            IRepository<Customer> customers = new MockContext<Customer>();
        ...
        public void CanCheckoutAndCreateOrder() {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "gorica.vasilevska@gmail.com", ZipCode = "1000" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("gorica.vasilevska@gmail.com", "Forms"), null);
